# Stuff which hasn't made it to README.md yet

PGRI is built using [protoc-gen-validate]{https://github.com/envoyproxy/protoc-gen-validate} as a template.  The following is all the stuff in their extensive README that hasn't been reworked.
